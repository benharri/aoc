...
/// </summary>
public sealed class Day14ReindeerOlympics() : Day(2015, 14, "Reindeer Olympics")
{
    private readonly List<Reindeer> _reindeer = [];

    public override void ProcessInput() => _reindeer.AddRange(Input.Select(i => new Reindeer(i)));
