...
/// </summary>
public sealed class Day17NoSuchThingAsTooMuch() : Day(2015, 17, "No Such Thing as Too Much")
{
    ...
    {
        _containers.AddRange(Input.Select(int.Parse));
        _combinations.AddRange(Enumerable.Range(1, (1 << _containers.Count) - 1)
